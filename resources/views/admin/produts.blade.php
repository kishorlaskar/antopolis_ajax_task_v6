            ...
            <table id="laravel_crud" class="table table-striped table-bordered">
                ...
                @foreach($products as $product)
                    <tr id="row_{{$product->id}}">
                        ...
                        <td>
                            <a href="javascript:void(0)" data-id="{{ $product->id }}" class="btn btn-danger" onclick="deleteProduct(event.target)">Delete</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
                    ...
                    <form name="productForm" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                <span id="subcategoryError" class="alert-message"></span>
                            </div>
                        </div>
                        <div class="form-group">
        ...
        function createProduct() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.code == 200) {
                        if(id != ""){
                            ...
                            $("#row_"+id+" td:nth-child(3)").html(response.data.subcategory_id);
                            $("#row_"+id+" td:nth-child(4)").html(response.data.brand_id);
                            $("#row_"+id+" td:nth-child(5)").html(response.data.product_name);
                            $("#row_"+id+" td:nth-child(6)").html(response.data.product_image);
                            $("#row_"+id+" td:nth-child(7)").html(response.data.product_color);
                            $("#row_"+id+" td:nth-child(8)").html(response.data.product_size);
                            $("#row_"+id+" td:nth-child(9)").html(response.data.product_quantity);
                            $("#row_"+id+" td:nth-child(10)").html(response.data.product_price);
                            $("#row_"+id+" td:nth-child(11)").html(response.data.product_short_description);
                            $("#row_"+id+" td:nth-child(12)").html(response.data.product_long_description);
                            $("#row_"+id+" td:nth-child(13)").html(response.data.publication_status);
                        } else {
                            $('table tbody').prepend('<tr id="row_'+response.data.id+'">' +
                                '<td>'+response.data.id+'</td>' +
                                '<td>'+response.data.category_id+'</td>' +
                                '<td>'+response.data.subcategory_id+'</td>' +
                ...
                errors: function(response) {
                    ...
                    $('#subcategoryError').text(response.responseJSON.errors.subcategory_id);
